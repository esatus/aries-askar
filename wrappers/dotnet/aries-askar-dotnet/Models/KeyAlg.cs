    ...
    public static class KeyAlgConverter
    {
        ...
        public static string ToKeyAlgString(this KeyAlg keyAlg)
        {
            switch (keyAlg)
            {
                ...
                case KeyAlg.A128CBC_HS256:
                    return "a128cbchs256";

                case KeyAlg.A256CBC_HS512:
                    return "a256cbchs512";
                ...
                case KeyAlg.BLS12_381_G1:
                    return "bls12381g1";

                case KeyAlg.BLS12_381_G2:
                    return "bls12381g2";

                case KeyAlg.BLS12_381_G1G2:
                    return "bls12381g1g2";
        ...
        public static KeyAlg ToKeyAlg(string keyAlgString)
        {
            ...
            {
                case "a128gcm":
                    return KeyAlg.A128GCM;
                case "a256gcm":
                    return KeyAlg.A256GCM;
                case "a128cbchs256":
                    return KeyAlg.A128CBC_HS256;
                case "a256cbchs512":
                    return KeyAlg.A256CBC_HS512;
                case "a128kw":
                    return KeyAlg.A128KW;
                case "a256kw":
                    return KeyAlg.A256KW;
                case "bls12381g1":
                    return KeyAlg.BLS12_381_G1;
                case "bls12381g2":
                    return KeyAlg.BLS12_381_G2;
                case "bls12381g1g2":
                    return KeyAlg.BLS12_381_G1G2;
                case "c20p":
                    return KeyAlg.C20P;
                case "xc20p":
                    return KeyAlg.XC20P;
                ...
                case "x25519":
                    return KeyAlg.X25519;
                case "k256":
                    return KeyAlg.K256;
                case "p256":
                    return KeyAlg.P256;
                default:
                    throw new ArgumentException($"Invalid argument provided for keyAlg string: {keyAlgString}");
            }
        }
        ...
        public static KeyAlg ToKeyAlgJwkCrv(string keyAlgString)
        {
            ...
            switch (keyAlgString)
            {
               ...
               case "P256":
                    return KeyAlg.P256;
                default:
                    throw new System.ArgumentException($"Invalid argument provided for keyAlg string: {keyAlgString}");
            }
        }
    }
